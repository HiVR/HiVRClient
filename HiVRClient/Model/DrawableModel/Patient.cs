// <copyright file="Patient.cs" company="HiVR">
...
namespace HiVRClient.Model.DrawableModel
{
    ...
    /// <summary>
    /// This class implements the patient.
    /// </summary>
    public class Patient : Drawable
    {
        #region Fields

        /// <summary>
        /// Gets the position of this Patient.
        /// </summary>
        public static readonly Vector3D DefaultPosition = new Vector3D(0D, 0.9D, 0D);

        /// <summary>
        /// Gets the rotation of this Patient.
        /// </summary>
        public static readonly Vector3D DefaultRotation = new Vector3D(0D, 0D, 0D);

        /// <summary>
        /// Gets the scale of this Patient.
        /// </summary>
        ...
        public Patient(int id, Vector3D position, Vector3D rotation, Vector3D scale) : base(id, position, rotation, scale)
        {
        }
