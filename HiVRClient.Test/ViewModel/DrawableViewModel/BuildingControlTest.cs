// <copyright file="BuildingControlTest.cs" company="HiVR">
...
{
    /// <summary>
    /// Test <see cref="BuildingControl"/> class.
    /// </summary>
    public class BuildingControlTest
    {
        ...
        public void TestConstructor()
        {
            ...
            var drawable = new Building(id, position, rotation, scale);

            var drawableControl = new BuildingControl(drawable);
