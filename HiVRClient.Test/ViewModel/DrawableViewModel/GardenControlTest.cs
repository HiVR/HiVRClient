// <copyright file="GardenControlTest.cs" company="HiVR">
...
{
    /// <summary>
    /// Test <see cref="GardenControl"/> class.
    /// </summary>
    public class GardenControlTest
    {
        ...
        public void TestConstructor()
        {
            ...
            var drawable = new Garden(id, position, rotation, scale);

            var drawableControl = new GardenControl(drawable);
