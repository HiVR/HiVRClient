// <copyright file="PatientControlTest.cs" company="HiVR">
...
{
    /// <summary>
    /// Test <see cref="PatientControl"/> class.
    /// </summary>
    public class PatientControlTest
    {
        ...
        public void TestConstructor()
        {
            ...
            var drawable = new Patient(id, position, rotation, scale);

            var drawableControl = new PatientControl(drawable);
