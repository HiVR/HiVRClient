// <copyright file="BenchControlTest.cs" company="HiVR">
...
{
    /// <summary>
    /// Test <see cref="BenchControl"/> class.
    /// </summary>
    public class BenchControlTest
    {
        #region Methods
        ...
        public void TestConstructor()
        {
            ...
            var drawable = new Bench(id, position, rotation, scale);

            var drawableControl = new BenchControl(drawable);
