// <copyright file="CarControlTest.cs" company="HiVR">
...
{
    /// <summary>
    /// Test <see cref="CarControl"/> class.
    /// </summary>
    public class CarControlTest
    {
        ...
        public void TestConstructor()
        {
            ...
            var drawable = new Car(id, position, rotation, scale);

            var drawableControl = new CarControl(drawable);
